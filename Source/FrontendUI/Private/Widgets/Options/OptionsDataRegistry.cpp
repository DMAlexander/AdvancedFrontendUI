...
void UOptionsDataRegistry::InitGameplayCollectionTab()
{
    ...
    //This the full code for constructing data interactor helper
    ...
    //Game Difficulty
    {
        ...
        GameDifficulty->SetDataDynamicSetter(MAKE_OPTIONS_DATA_CONTROL(GetCurrentGameDifficulty));
...
void UOptionsDataRegistry::InitAudioCollectionTab()
{
    ...
    //Volume Category
    {
        ...
        //Music Volume
        {
            ...
            MusicVolume->SetDescriptionRichText(FText::FromString(TEXT("This is description for MusicVolume")));
...
void UOptionsDataRegistry::InitVideoCollectionTab()
{
    ...
    //Display Category
    {
        ...
        //WindowMode
        {
            ...
            WindowMode->AddEnumOption(EWindowMode::Windowed,FText::FromString(TEXT("Window")));
        ...
        //Screen Resolution
        {
            ...
            ScreenResolution->SetDataDynamicGetter(MAKE_OPTIONS_DATA_CONTROL(GetFullscreenMode));
            ScreenResolution->SetDataDynamicSetter(MAKE_OPTIONS_DATA_CONTROL(SetFullscreenMode));
    ...
    //Graphics Category
    {
        ...
        //Resolution Scale
        {
            ...
            ResolutionScale->SetNumberFormattingOptions(UListDataObject_Scalar::NoDecimal()); //No Decimal: 50% //One Decimal: 50.5%
    ...
    //Advanced Graphics Category
    {
        ...
        //Vertical Sync
        {
            ...
            VerticalSync->SetDescriptionRichText(FText::FromString(TEXT("This is a description for V-Sync")));
        ...
        //Frame Rate Limit
        {
            ...
            FrameRateLimit->SetDataDynamicSetter(MAKE_OPTIONS_DATA_CONTROL(GetFrameRateLimit));
                ...
                for (const TPair<FName, FKeyMappingRow>& MappingRowPair : MappableKeyProfile->GetPlayerMappingRows())
                {
                    for (const FPlayerKeyMapping& KeyMapping : MappingRowPair.Value.Mappings)
                    {
                        if (MappableKeyProfile->DoesMappingPassQueryOptions(KeyMapping, GamepadOnly))
                        {
                            /*Debug::Print(
                                TEXT(" Mapping ID: ") + KeyMapping.GetMappingName().ToString() +
                                TEXT(" Display Name: ") + KeyMapping.GetMappingName().ToString() +
                                TEXT(" Bound Key: ") + KeyMapping.SetCurrentKey().GetDisplayName().ToString()
                            );*/
